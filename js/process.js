...
let process = {
	...
	let source_vid = '#';
		let content = <div>
			...
			<center>
				<h1><a href='front.jsx' onClick={process.page1}>PSU</a></h1>
				<h1><a href='history.jsx' onClick={process.page2}>History</a></h1>
				<h1><a href='history1.jsx' onClick={process.page3}>Presidents of PSU</a></h1>
				<h1><a href='vision.jsx' onClick={process.page4}>Vision</a></h1>
				<h1><a href='mission.jsx' onClick={process.page5}>Mission</a></h1>
				<h1><a href='core.jsx' onClick={process.page6}>Core Values</a></h1>
				<h1><a href='Quality.jsx' onClick={process.page7}>Quality Policy</a></h1>
				<h1><a href='song.jsx' onClick={process.page8}>PSU Hymn</a></h1>
			</center>
		</div>;
